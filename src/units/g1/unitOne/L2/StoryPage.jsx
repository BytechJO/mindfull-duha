...
const video1 = "https://res.cloudinary.com/dyf5xqazg/video/upload/v1765792713/2-1_qx6i2r.mp4";
const video2 = "https://res.cloudinary.com/dyf5xqazg/video/upload/v1765792715/2-2_zkf9em.mp4";
const video3 = "https://res.cloudinary.com/dyf5xqazg/video/upload/v1765792714/2-3_ozd784.mp4";
const video4 = "https://res.cloudinary.com/dyf5xqazg/video/upload/v1765792716/2-4_djhqkp.mp4";
const video5 = "https://res.cloudinary.com/dyf5xqazg/video/upload/v1765792718/2-5_tobbza.mp4";
...
export const StoryPage = () => {
  ...
  const cloudPositions = {
    ...
    3: [
      { bottom: '80%', left: '58%', transform: 'translateX(-50%)' },
      { top: '10%', left: '50%', isFlipped: true }
    ],
    4: [
      { top: '10%', left: '50%', transform: 'translateX(-50%)', isFlipped: true },
      { top: '10%', left: '5%', isFlipped: true },
    ]
  };
