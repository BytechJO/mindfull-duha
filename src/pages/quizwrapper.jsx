...
export default function VideoPlayerPage() {
  ...
  return (
    <div className="h-screen w-screen relative overflow-hidden flex flex-col">
      {/* ✅ مهم: منع الخلفيات المتحركة من سرقة الضغط */}
      <div className="pointer-events-none absolute inset-0">
        <AnimatedBackground />
        <AnimatedCharacter />
      </div>

      <div className="flex-1 p-4 sm:p-6 md:p-8 flex items-center justify-center overflow-hidden relative z-10">
      ...
      <div className="w-full h-[2px] bg-white/30 relative z-20" />
      <motion.div
